              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchBarcelona" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchSevilla" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?address=San%20Sebastián%2C%20Gipuzkoa%2C%20Spain&bounds=43.338233%2C-1.88766%2C43.21807%2C-2.086736',
                    }}
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchSanSebastian" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    to={{
                      search:
                        '?address=Valencia%20Province%2C%20Spain&bounds=40.211683%2C0.020447%2C38.686554%2C-1.528945',
                    }}
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchValencia" />
                  </NamedLink>
                </li>
              </ul>
            </div>
